...
public class HeapFileEncoder {
   ...
   *
   * <p>The format of the output file will be as specified in HeapPage and HeapFile.
   *
  ...
  public static void convert(
      File inFile, File outFile, int npagebytes, int numFields, Type[] typeAr) throws IOException {
   ...
   */
  public static void convert(
      File inFile, File outFile, int npagebytes, int numFields, Type[] typeAr, char fieldSeparator)
      throws IOException {
