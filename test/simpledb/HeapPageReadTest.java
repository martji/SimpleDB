...
public class HeapPageReadTest extends SimpleDbTestBase {
  ...
  public static final int[][] EXAMPLE_VALUES =
      new int[][] {
        {31933, 862},
        {29402, 56883},
        {1468, 5825},
  ...
  public void addTable() throws Exception {
    ...
    Database.getCatalog()
        .addTable(new SkeletonFile(-1, Utility.getTupleDesc(2)), SystemTestUtil.getUUID());
  }
  ...
  public void getSlot() throws Exception {
    ...
    for (int i = 0; i < 20; ++i) assertTrue(page.isSlotUsed(i));

    for (int i = 20; i < 504; ++i) assertFalse(page.isSlotUsed(i));
  }
