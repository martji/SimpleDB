...
public interface DbFile {
  ...
  /**
   * Removes the specifed tuple from the file on behalf of the specified transaction. This method
   ...
   *
   * <p>Implementation note: you will need to generate this tableid somewhere, ensure that each
   ...
   * underlying the HeapFile, i.e. <code>f.getAbsoluteFile().hashCode()
   * </code>.
   *
